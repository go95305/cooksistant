...
public class RecipeController {
    ...
    public void mainImage(@RequestParam("originalName") String originalName, @RequestParam("recipeId") Long recipeId, @RequestParam("file") MultipartFile file) throws IOException {
